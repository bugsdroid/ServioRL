...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: AppColors.background, title: const Text('Search')),
      body: Column(
        ...
        children: [
          ...
          if (!seerrOk)
            Expanded(child: _NotConfiguredBanner())
          else ...[  
            Padding(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: selected ? AppColors.teal : AppColors.border, width: 0.5),
        ),
        child: Text(label,
            style: TextStyle(
    ...
    return ListView(
      ...
      children: [
        ...
        Wrap(
          ...
          children: _popular.map((q) => GestureDetector(
                onTap: () => onPopular(q),
                child: Container(
        ...
        trendingMovies.when(
          ...
          error: (e, _) => _GridError(message: 'Tidak bisa load trending — $e'),
...
class _PosterCard extends ConsumerWidget {
  ...
  Widget _fallback() => Container(
      ...
      color: AppColors.surfaceVariant,
      child: Icon(
          item.mediaType == MediaType.tv ? Icons.tv_outlined : Icons.movie_outlined,
  ...
  Future<void> _request() async {
    ...
    try {
      await ref.read(searchRepositoryProvider).requestMedia(
            widget.item.id, widget.item.mediaTypeStr);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(width: double.infinity, child: _RequestBtn(item: r)),
                  const SizedBox(height: 16),
                  if (r.overview.isNotEmpty) ...[
                    const Text('Overview',
                        style: TextStyle(
