...
class AppConfigNotifier extends StateNotifier<AppConfig> {
  ...
  static AppConfig _load(SharedPreferences p) => AppConfig(
        ...
        overseerrBaseUrl:     p.getString('overseerr_url')      ?? '',
        overseerrApiKey:      p.getString('overseerr_key')      ?? '',
  ...
  Future<void> save(AppConfig config) async {
    ...
    await Future.wait([
      ...
      _prefs.setString('overseerr_url',     config.overseerrBaseUrl),
      _prefs.setString('overseerr_key',     config.overseerrApiKey),
